...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.GetEmpsWithSubordinates2(Emps);
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                ...
                .Where(r => r.EmployeeCount == 5 || r.EmployeeCount == 0)
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            var result = (from mgrs in emps
                         join emp in emps on mgrs.Empno equals emp.Mgr?.Empno
                         where emp.Mgr != null
                         orderby mgrs.Ename ascending, mgrs.Salary descending
                         select mgrs).Distinct();
            return result;
        }
